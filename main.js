...
let currentValue = 0;
const limit = 5; //cantidad de estrellitas

const html = Array.from(Array(limit)).map( (_, i) => { //crea un arreglo basado en el parametro que ingreso, que puede ser un obj iterable. Creo un arreglo basado en el arreglo que tengo en limit
